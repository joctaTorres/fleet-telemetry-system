---
name: ratchet-batch
description: Advance a Ratchet batch by one step. Use when the user wants to drive a batch forward one transition (propose/apply/verify) via the bundled engine, keeping inspection points between steps.
license: MIT
...
Advance a Ratchet batch by exactly one step.
